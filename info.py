...
API_ID = int(environ.get('API_ID', '14656169'))
API_HASH = environ.get('API_HASH', 'a2d5b45af5a62c674591e4eeeddc96d9')
BOT_TOKEN = environ.get('BOT_TOKEN', "7260442537:AAGKbxrxhsGgCaHZmUTnukHfevWIL0Ck1Gs")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5844415850 6249148586 6133992240').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001910170881')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yedekhosine:Achiadi123@cluster0.3nqpdeh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'fMDCfdHbglU811sJLQSQMinDXCB3')
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'api.shareus.io')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'fMDCfdHbglU811sJLQSQMinDXCB3')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/yedekho_faq')
